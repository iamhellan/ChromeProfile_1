...
public class v2_MOBI_email_authorization {
    ...
    void loginWithEmailAndSms() {
        ...
        try {
            ...
            page.waitForTimeout(1000);
            page.fill("input#auth_id_email", ConfigHelper.get("google.email"));

            System.out.println("Вводим пароль");
            page.waitForTimeout(1000);
            page.fill("input#auth-form-password", ConfigHelper.get("google.password"));
            ...
            System.out.println("Берём последнее сообщение в верхнем чате");
            ...
            String msg = "✅ *v2_MOBI_email_authorization завершён успешно*\n\n"
